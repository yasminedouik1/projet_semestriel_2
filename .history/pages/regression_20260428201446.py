...
def show_page():
    st.title("📈 Régression - Score de Dépression")
    ...
    with st.container():
        ...
        predict_btn = st.button("🚀 Prédire le Score de Dépression", type="primary", use_container_width=True)
    ...
    if predict_btn:
        with st.container():
            ...
            user_input = {
                ...
                # Features one-hot / encodées (valeurs par défaut)
        ...
        st.info("👆 Remplissez le formulaire ci-dessus et cliquez sur **Prédire le Score de Dépression**")